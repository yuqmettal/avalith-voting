...
INSERT INTO employes (username, password, enabled, first_name, last_name, email) VALUES ('marco','$2a$04$Bn3UVpMaH65PWb5yVqial.xFzFgcucvoR5sg4tpA/wbprGFFi7sxm',true, 'Marco', 'Yuquilima','myuquilima@yuqmettal.com');
INSERT INTO employes (username, password, enabled, first_name, last_name, email) VALUES ('admin','$2a$04$t78hYPjiY2enNx0HwpSK3.aZmDUXArthOcD6a7CbogeKEFY22H7DO',true, 'John', 'Doe','jhon.doe@bolsadeideas.com');
